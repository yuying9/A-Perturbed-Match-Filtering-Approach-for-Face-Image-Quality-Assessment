...
path = "../data/quality_data/XQLFW/"
outpath = "../data/quality_data"

dataset_name = 'XQLFW'
rel_img_path = os.path.join(outpath, dataset_name, "images")
...
def create_xqlfw_pairs(pairs_filename):
    ...
    for line in f.readlines()[1:]:
        ...
        txt_file.write(os.path.join('XQLFW/images', img_name1)+"\n")
        txt_file.write(os.path.join('XQLFW/images', img_name2)+"\n")
...
create_xqlfw_pairs("../data/quality_data/XQLFW/xqlfw_pairs.txt")
